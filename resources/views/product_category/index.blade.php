    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="text-right">
                <a class="btn btn-primary" href="/product_category/create-index">
                    ...
                    <tbody class="text-center">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="/product_category/edit-index/{{$dtpc->id}}" class="btn btn-sm btn-warning"><i class="fas fa-edit text-white"></i></a>

                                <a href="/product_category/delete/{{$dtpc->id}}" class="btn btn-sm btn-danger"><i class="fas fa-trash"></i></a>
